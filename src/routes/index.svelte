...
<div class="flex min-h-screen items-center justify-center">
	<div>
		...
		<header class="text-center mb-10 px-4 sm:px-16">
			...
			<p class="text-2xl sm:text-6xl font-extrabold text-gray-800 leading-snug">Publish your blog posts on <a class="underline" href="https://telegra.ph" target="_blank">Telegra.ph</a></p>
		</header>
